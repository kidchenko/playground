...
namespace LinqUpTests
{
    ...
    {
        [Fact]
        public void EmptyInputReturnsNoOccurances()
        {
            var classUnderTest = new CharacterFrequencyCounter();

            var actual = classUnderTest.CountFrequencyOfCharacters(string.Empty);

            Assert.Equal("Character frequencies for \"\" are:\r\n", actual);
        }

        [Fact]
        public void AAAReturnsAOccursThrice()
        {
            var classUnderTest = new CharacterFrequencyCounter();
            var input = "AAA";
            var expected = $"Character frequencies for \"{input}\" are:\r\n[A]: 3 occurances\r\n";

            var actual = classUnderTest.CountFrequencyOfCharacters(input);

            Assert.Equal(expected, actual);
        }

        [Fact]
        public void TDDReturnsTOnceAndDTwice()
        {
            var classUnderTest = new CharacterFrequencyCounter();
            var input = "TDD";
            var expected = $"Character frequencies for \"{input}\" are:\r\n[T]: 1 occurances\r\n[D]: 2 occurances\r\n";
        ...
        [Fact]
        public void TheQuickBrownFoxReturnsProperFrequencies()
        {
            var classUnderTest = new CharacterFrequencyCounter();
        ...
        [Fact]
        public void LongTextPerformance()
        {
            var classUnderTest = new CharacterFrequencyCounter();
            var input = @"
PETER PAN
...
THE END";
            ...
            stopwatch.Start();
            classUnderTest.CountFrequencyOfCharacters(input);
            stopwatch.Stop();

            var elapsedMilliSeconds = stopwatch.ElapsedMilliseconds;

            Console.WriteLine($"Characters counted in long text took {elapsedMilliSeconds} milliseconds.");

            // No assert. Just reporting performance here.
        }
    }
}